  ...
  return (
    <div className="flex flex-col lg:flex-row gap-6 animate-in fade-in duration-300">
      ...
      <div className="flex-1 flex flex-col gap-4">
        ...
        {/* Legend */}
        <div className="flex items-center gap-4 px-2 text-[10px] font-black">
          <div className="flex items-center gap-1.5 text-foreground"><div className="w-3 h-3 rounded-full bg-primary shadow-sm"></div> CD Villaralbo ({formacionLocal})</div>
          {mostrarRival && <div className="flex items-center gap-1.5 text-foreground"><div className="w-3 h-3 rounded-full bg-rose-600 shadow-sm"></div> {rivalName} ({formacionRival})</div>}
        </div>
